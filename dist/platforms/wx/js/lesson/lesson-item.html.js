				...
				[
					...
					[
						...
						(function () {
						    ...
						    var __for_12_1 = this.remark;
						    var __for_12_2 = [];

						    for (var index = 0, __for_12_len = __for_12_1.length; index < __for_12_len; index++)
						    {
						        var item = __for_12_1[index];

						        __for_12_2.push.apply(__for_12_2,
									[
										[
											"text",
											{
