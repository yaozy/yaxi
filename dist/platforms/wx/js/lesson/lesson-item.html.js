				...
				[
					...
					[
						...
						(function () {
						    ...
						    var __for_28_1 = this.remark;
						    var __for_28_2 = [];

						    for (var index = 0, __for_28_len = __for_28_1.length; index < __for_28_len; index++)
						    {
						        var item = __for_28_1[index];

						        __for_28_2.push.apply(__for_28_2,
									[
										[
											"text",
											{
